...
func (r HeadacheTestRepo) ListHeadaches() []entity.Headache {
	return []entity.Headache{}
}
...
func (r HeadacheTestRepo) PatchHeadache(haId uint, date *time.Time, severity *entity.Severity, types *entity.HeadacheTypes, positions *entity.HeadachePositions, symptoms *entity.HeadacheSymptoms) error {
	return nil
}
