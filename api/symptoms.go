...
// encore:api auth method=GET path=/piid/:piid/symptoms tag:external
...
// encore:api auth method=PATCH path=/piid/:piid/symptoms/:id/name tag:external
...
// encore:api auth method=PATCH path=/piid/:piid/symptoms/:id/category tag:external
...
// encore:api auth method=POST path=/piid/:piid/symptom-categories tag:external
...
// encore:api auth method=PATCH path=/piid/:piid/symptom-categories/:id tag:external
...
// encore:api auth method=DELETE path=/piid/:piid/symptom-categories/:id tag:external
