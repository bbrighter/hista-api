...
type (
	IIntakeRepo interface {
		List(ctx context.Context) ([]*entity.Intake, error)
		ListGrouped(ctx context.Context) (entity.GroupedIntakeList, error)
...
func (uc IntakeMgmtUseCase) ListGrouped(ctx context.Context) (entity.GroupedIntakeList, error) {
	return uc.r.ListGrouped(ctx)
}
...
func (uc IntakeMgmtUseCase) List(ctx context.Context) ([]*entity.Intake, error) {
